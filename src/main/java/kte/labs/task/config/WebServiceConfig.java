...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition groupsWsdl11Definition(XsdSchema productsSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://www.user.com/spring/ws/products");
        wsdl11Definition.setSchema(productsSchema);
        return wsdl11Definition;
    }

    @Bean(name = "clients")
    public DefaultWsdl11Definition studentsWsdl11Definition(XsdSchema clientsSchema) {
        DefaultWsdl11Definition wsdl11Definition = new DefaultWsdl11Definition();
        wsdl11Definition.setPortTypeName("ClientsPort");
        wsdl11Definition.setLocationUri("/ws");
        wsdl11Definition.setTargetNamespace("http://www.user.com/spring/ws/clients");
